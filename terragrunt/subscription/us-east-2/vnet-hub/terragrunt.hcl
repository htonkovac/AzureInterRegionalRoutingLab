...
inputs = {
  vnet_name           = "vnet-hub-${local.location}-001"
  ...
  subnet_names        = ["AzureBastionSubnet", "GatewaySubnet", "AzureFirewallSubnet", "AzureFirewallManagementSubnet", "ApplicationGatewaySubnet","TestingSubnet"]
